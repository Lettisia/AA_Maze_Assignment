 ...
 * @author Jeffrey Chan
 *
 *         Abstract class of Maze defines the interface and a set of constants
 *         common for every type of maze in the assignment. solvers require
 *         that: all cells are stored in matrix map[][], map[r][c].r == r and
 *         map[r][c].c == c, all neighbour cell objects are assigned correctly
 *         for each cell, and same wall object are shared by two cell objects
 *         next to the wall
 */
public abstract class Maze {
	...
	// e.g., the northeast neighbour of map[r][c] would be map[r +
	// deltaR[NORTHEAST][c + deltaC[NORTHEAST]]
	 ...
	 * @param c
	 *            Column of a cell.
	 * @return true if the cell is on any of the four sides of the maze.
	 *         Otherwise false.
	 */
	public abstract boolean isOnEdge(int r, int c);

	/**
	 * Initialise the basic structure of an all-wall maze.
	 * 
	 * @param rs
	 ...
	 * @param entR
	 *            Row coordinate of entrance.
	 * @param entC
	 *            Column coordinate of entrance.
	 * @param exitR
	 *            Row coordinate of exit.
	 * @param exitC
	 *            Column coordinate of exit.
	 * @param tunnelList
	 *            A list tunnels, each in the form of {p1Row, p1Col,
	 *            p2Row,p2Col}.
	 */
	 ...
	 * 
	 * @return true if it is perfect maze, i.e. every cell can be visited and
	 *         there is no loop.
	 */
