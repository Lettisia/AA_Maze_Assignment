 ...
 * @author Youhan Xia
 * @author Jeffrey Chan
 * @author Yongli Ren Main class for testing the maze generators and solvers.
 */
class MazeTester {
	 ...
	 * 
	 * @param args
	 *            Two arguments which are input filename and "y/n" indicating
	 *            whether to visualize the maze.
	 */
	public static void main(String[] args) {
		...
		// note that drawFtPrt(Cell) need to be called for validating the
		// solution
		switch (args[1]) {
		case "y":
			isVisu = true;
		...
		try {
			...
			while (scanner.hasNext()) {
				int temp[] = { Integer.parseInt(scanner.next()), Integer.parseInt(scanner.next()),
